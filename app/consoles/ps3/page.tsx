...
import myPic from "@/public/ps3.png";
  ...
  useEffect(() => {
    ...
    async function fetchAndProcessPrices() {
      try {
        ...
        const processedData = await s3Service.fetchPrices("ps3Scraper.json");
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <AdditionalInfo
                ...
                average={average}
                current_average={
                  data && data.ps3Scraper
                    ? parseFloat(data.ps3Scraper).toFixed(2)
                    : null
                }
              />
            </div>
