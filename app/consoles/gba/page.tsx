...
import myPic from "@/public/gba.png";
  ...
  useEffect(() => {
    ...
    async function fetchAndProcessPrices() {
      try {
        ...
        const processedData = await s3Service.fetchPrices("gbaScraper.json");
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <AdditionalInfo
                ...
                average={average}
                current_average={
                  data && data.gbaScraper
                    ? parseFloat(data.gbaScraper).toFixed(2)
                    : null
                }
              />
            </div>
